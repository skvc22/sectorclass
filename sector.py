...
class sectorclass(pdastroclass):
    ...
    def define_options(self,parser=None,usage=None,conflict_handler='resolve'):
        ...
        parser.add_argument('--secs4SNefile', default=None, help='output file to SNe matched with sectors. default is None.')
    ...
    def get_arguments(self, args, configfile = None):
        ...
        self.params['secs4SNe_filename'] = args.secs4SNefile
    ...
    def readInTables(self):
        ...
        exists = True
        i = 1
        self.t = pd.read_csv('https://tess.mit.edu/wp-content/uploads/orbit_times_20220705_1224.csv')
    ...
    def default_secs4SNe_filename(self, name=None):
        """
        Set default file name from which to read the list of SNe and to save the final
        table to. 

        @param name: name of the default file to be used
        @return: name of the default file
        """
        if name is not None:
            self.secs4SNe_filename = name
        if self.secs4SNe_filename is None and name is None:
            raise RuntimeError('Need to set secs4SNe_filename')
        return self.secs4SNe_filename
    ...
    def load_secs4SNe(self, filename=None):
        ...
        """
        if filename is None:
            filename = self.default_secs4SNe_filename()
...
if __name__ == '__main__':
    ...
    test.default_secs4SNe_filename(args.secs4SNefile)
